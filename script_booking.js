...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const tours = {
        ...
        one_d_one_n: ['Historical Sites', 'Cultural Festivals', 'City Tours', 'Museum Visits'],
        two_d_one_n: ['Spa Retreats', 'Beach Vacations', 'Cruises', 'Yoga Retreats'],
        two_d_two_n: ['Safari', 'Bird Watching', 'Nature Trails', 'Wildlife Photography']
    };
